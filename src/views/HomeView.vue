<template>
  <div>
    ...
    <!-- Mall Modal -->
    <div v-if="showMallModal" class="fixed inset-0 z-50 flex">
      <!-- Background -->
      <div class="absolute inset-0 bg-black/80 backdrop-blur-sm" @click="closeMall"></div>
        ...
        <div class="sticky top-0 bg-gray-900/95 backdrop-blur-lg border-b border-gray-700/50 z-10">
          <div class="flex items-center justify-between px-6 py-4">
            <div class="flex items-center space-x-3">
              <button @click="closeMall" class="p-2 rounded-full hover:bg-gray-700/50 transition-colors">
